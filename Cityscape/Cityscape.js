  ...
  return (
    <div className="cityscape-container">
      ...
      <div className="city-silhouette">
        ...
        <Building width={300} height={850} windowRows={12} windowCols={6} zIndex={5} />
        <Building width={620} height={850} windowRows={18} windowCols={7} zIndex={4} />
        <Building width={790} height={850} windowRows={15} windowCols={5} zIndex={6} />
        <Building width={750} height={850} windowRows={20} windowCols={8} zIndex={3} />
        <Building width={610} height={850} windowRows={14} windowCols={6} zIndex={7} />
      </div>
    </div>
  );
};
